                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row"> <label for="alamat_siswa" class="col-sm-2 col-form-label">Alamat</label>
                                        <div class="col-sm-10"> <input type="text" class="form-control" id="alamat_siswa" name="alamat_siswa" value="<?= $siswa !== null ? $siswa['alamat_siswa'] : ''; ?>" placeholder="Alamat Siswa" required> </div>
                                    </div>
                                    <div class="form-group row"> <label for="periode" class="col-sm-2 col-form-label">Periode</label>
                                        <div class="col-sm-10"> <input type="number" min="1900" max="2099" step="1" class="form-control" id="periode" name="periode" value="<?= $siswa !== null ? $siswa['periode'] : ''; ?>" placeholder="Tahun Periode" required> </div>
                                    </div>
                                </div>
                            </div>
                        </div> 
