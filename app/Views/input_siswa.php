...
<div class="container-fluid">
    <section class="section">
        ...
        <div class="section-body">
            <form action="/home/addsiswa/" method="POST">
                <?= csrf_field(); ?>
                <!-- Tabel Input -->
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="nis_siswa" class="col-sm-2 col-form-label">NIS</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="nis_siswa" id="nis_siswa"
                                            placeholder="NIS Siswa" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="kelas_siswa" class="col-sm-2 col-form-label">Jurusan</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="1900" max="2099" step="1" class="form-control"
                                            id="periode" name="periode" placeholder="Tahun Periode" required>
                                    </div>
                                </div>
                            </div>
                        </div>
